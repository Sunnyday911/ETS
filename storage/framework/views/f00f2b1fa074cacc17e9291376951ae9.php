...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['href' => ''.e(route('more', $cust->id)).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('more', $cust->id)).'']); ?>
          <div class="space-y-1">
            <h3 class="text-xl font-semibold text-slate-800"><?php echo e($cust->name); ?></h3>
          </div>
...
<?php endif; ?><?php /**PATH C:\Users\USER\Herd\vet\resources\views/Customer.blade.php ENDPATH**/ ?>